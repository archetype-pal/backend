...
class TestRequestIDMiddleware:
    ...
    def test_response_carries_minted_id_when_request_has_none(self, api_client):
        ...
        # Search endpoint may 502/500 without Meilisearch; we only care about headers.
    ...
    def test_each_request_without_incoming_id_gets_a_unique_id(self, api_client):
        r1 = api_client.get("/api/v1/search/item-parts/")
        r2 = api_client.get("/api/v1/search/item-parts/")
